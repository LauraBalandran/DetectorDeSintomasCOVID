 ...
 * Basado en el código por: Hugo Escalpelo
 * Fecha: 30 de Agosto del 2022
 * Modificado por: Laura del Rocio Balandrán C.
 * Fecha: 30 de Agosto del 2022
 * 
 ...
 * controlador ESP32CAM, la primera parte realiza la lectura de 25 muestras 
 * del sensor MAX30102 cada cuatro segundos.
 * 
 * MAX30102     ESP32CAM
 * 5v-----------5V
 * GND----------GND
...
long timeNow, timeLastMQTT, timeLastMax30102; // Variables de control de tiempo no bloqueante
int wait = 5000;  // Indica la espera cada 5 segundos para envío de mensajes MQTT
int waitMax30102 = 4000; // Espera para lectua del sensor MAX30102
...
void setup() {
  ...
  //Pines Indicadores de funcionamiento del MAX30102
