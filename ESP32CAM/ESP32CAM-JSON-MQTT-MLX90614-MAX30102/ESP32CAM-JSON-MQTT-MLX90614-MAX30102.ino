 ...
 * cada cuatro segundos del sensor MAX30102, se conectará en paralelo con 
 * el sensor MLX90614.
 * 
 * MAX30102     ESP32CAM
 * 5v-----------5V
...
long timeNow, timeLastMQTT, timeLastMax30102, timeLastMLX; // Variables de control de tiempo no bloqueante
